...
from signatures import Sign, Verify, sig_keygen
from elgamal import (ElGamalParams, elgamal_keygen, ElGamal_Enc, ElGamal_Dec,
                     malleability_attack_multiply)
from miller_rabin import mod_exp
...
def verify_lineage():
    ...
    from miller_rabin import miller_rabin, gen_safe_prime
    from rsa import rsa_keygen, fast_modexp
