...
from Q13_miller_rabin import  gen_safe_prime, is_prime
...
class MITM_Attack:
    ...
    def __init__(self, params: DHParams):
        ...
        self.E = pow(params.g, self.e, params.p)
        self.K_alice = None
        self.K_bob = None
    ...
    def intercept_from_alice(self, A: int) -> int:
        ...
        """
        self.K_alice = pow(A, self.e, self.params.p)
    ...
    def intercept_from_bob(self, B: int) -> int:
        ...
        Computes K_bob = B^e.
        """
        self.K_bob = pow(B, self.e, self.params.p)
...
def cdh_hardness_demo(params: DHParams):
    ...
    A = pow(params.g, a, params.p)
    B = pow(params.g, b, params.p)
    K = pow(params.g, (a*b) % params.q, params.p)
    print(f"    A={A}  B={B}  K={K}")
