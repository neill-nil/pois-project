...
from Q12_rsa import rsa_keygen, rsa_enc, rsa_dec, fast_modexp, mod_inverse, pkcs15_enc, extended_gcd
from Q13_miller_rabin import mod_exp, gen_prime
...
def performance_comparison(sk, pk, n_trials: int = 1000) -> dict:
    ...
    FIX: n_trials=10 (was 100); explicitly verifies 100 messages for correctness.
    """
    N, _ = pk
...
if __name__ == "__main__":
    ...
    for bits, pk_b, sk_b in [
        ...
        perf = performance_comparison(sk_b, pk_b, n_trials=10)
