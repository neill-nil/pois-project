...
from Q13_miller_rabin import gen_safe_prime,  miller_rabin, mod_exp
from Q12_rsa import (rsa_keygen, rsa_enc, rsa_dec, extended_gcd, mod_inverse,
                 fast_modexp)
...
class SchnorrSignature:
    ...
    def __init__(self, bits: int = 256):
        ...
        from Q13_miller_rabin import gen_safe_prime, mod_exp
